  ...
  return (
    <nav className='navbarContainer'>
      ...
      <ul className='listContainer'>
        <li className='listItem'><Link className='listlink' to="#" smooth={true} duration={500}>Home</Link></li>
        ...
        <li className='listItem verifybtn'><Link to="#" smooth={true} duration={500}>Verify Now</Link></li>
      </ul>
